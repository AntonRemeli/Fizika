...
?>
<style>
.wsite-background {background-image: url("http://eskipaper.com/images/cosmos-wallpaper-4.jpg") !important;background-repeat: no-repeat !important;background-position: 50% 50% !important;background-size: 110% !important;background-color: transparent !important;}
...
?>
	<a href="">
	<span id="wsite-title"><small><small> 0604 Penészgátló csodafesték, hőszigetelés vagy párátlanítás?   </small></small> </span>	
	</a>
</span></div>
...
?>	 
  ...
  <script type="text/javascript" src="<?php  echo $hF;?>@/0files/theme/plugins.js"></script>
  <script type="text/javascript" src="<?php  echo $hF;?>@/0files/theme/custom.js"></script>
	</body>
</html>
