...
<title>FIZIKApofonEGYSZER&#219;EN</title>
...
function href(){
//	url="http://31.220.111.193/Fizika/in/index.php?L=hu&bn="+browserName+"&bv="+fullVersion;
//	url="<?php echo $hF; ?>in/index.php?L=hu&bn="+browserName+"&bv="+fullVersion;
	url="in/index.php?L=hu&bn="+browserName+"&bv="+fullVersion;
//url="login.php";
return url;
}
// document.write(href());
...
document.write('<iframe  width="100%" height="100%" src="'+href()+'" frameborder="0" allowfullscreen></iframe>');	
