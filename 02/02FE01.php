...
$i = "'";
 ...
 if ($pap==1) echo '  <table style="width: 100%;"><tbody><tr> <td><a href="'. $hF.'02/02FE.php?par=0&pap=1"><img  src="'. $hF.'@/01vissza.jpg" alt="vissza" title="vissza" border="0" /></a></td>  <td style="text-align: right;"><a href="'. $hF.'02/02FE02.php?par=0&pap=1"><img src="'. $hF.'@/02elore.jpg"  alt="előre"  title="előre" title="előre" /> </a></td></tr></tbody></table>'; 
...
if ($par==1) echo 'target="_blank"'; 
  ...
  if ($par==0) echo '<a href="'. $hF.'02/02FE.php" >  <img  src="'. $hF.'@/00fel.jpg" title="Vissza az anyagszerkezethez" alt="Vissza az anyagszerkezethez" border="0" /></a></h2> </td>  <td align="right">   <h2 style="text-align: right;"> <a href="'. $hF.'in/inFE.php">  <img  src="'. $hF.'@/00fel.jpg" title="Bevezető megnyitása lassú hálózatban" alt="Bevezető megnyitása lassú hálózatban" border="0" /></a>  <a href="'. $hF.'in/index.php">Fizika egyszerűen</a> ';
   ...
   if ($par==1) echo ' <a href="javascript:void(0)" onclick="open_url('.$i.''.$hF.'00.php'.$i.','.$i.'02FE01'.$i.');">  <img src="'.$hF.'@/07befejt.jpeg" alt="Mesét becsukom" title="Mesét becsukom" align="right" border="0" ></a>';
   
  echo '   </h2>  </td></tr></tbody></table>.';

include_once $pF . "@@/M0201.php";
 ...
 <a href="'. $hF.'02/02FE01.php" target="_blank">&nbsp</a></td>
 <td align="right"><a href="'. $hF.'in/index.php" >&nbsp;</a>
 <a href="javascript:void(0)" onclick="open_url('. $i.''. $hF.'00.php'. $i.','. $i.'02FE01'. $i.');">
