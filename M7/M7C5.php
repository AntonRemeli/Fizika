...
<td><a href="M7C4.php"><img title="vissza" src="<?php  echo $hF; ?>@/01vissza.jpg" alt="vissza" border="0" /></a></td>
<td style="text-align: right;"><a href="M7C6.php"><img src="<?php  echo $hF; ?>@/02elore.jpg" alt="előre" title="előre" /> </a></td></tr></tbody></table>

<table style="width: 100%;"> <tbody> <tr> <td>
<h2><a   href="M7C5.php" >C5. Az erőmérés. Erő-ellenerő	58   </a><a href="M7FE.php">  <img  src="<?php  echo $hF; ?>@/00fel.jpg" title="Vissza a tartalomjegyzékhez" alt="Vissza a tartalomjegyzékhez" border="0" /></a></h2> </td> <td>
...
<?php  include_once($pF . "@@/D6ellenerő.php");?>
<br><br>
HF: G-1,6,7,8
</td></tr></tbody></table>
<br><br>
...
</td></tr></tbody></table><p><img style="width: 100%;" src="M7C5.jpeg" title="C5. Az erőmérés. Erő-ellenerő	58 "  alt="C5. Az erőmérés. Erő-ellenerő	58" /></p>

<table style="width: 100%;"><tbody><tr>
<td><a href="M7C4.php"><img title="vissza" src="<?php  echo $hF; ?>@/01vissza.jpg" alt="vissza" border="0" /></a></td>
<td style="text-align: right;"><a href="M7C6.php"><img src="<?php  echo $hF; ?>@/02elore.jpg" alt="előre" /> </a></td>
</tr></tbody></table>
